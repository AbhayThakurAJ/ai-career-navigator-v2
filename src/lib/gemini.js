...
function buildPrompt(profile, goal) {
...
export async function generateRoadmap(profile, goal) {
  if (!API_KEY) {
...
export function fallbackRoadmap(profile, goal) {
